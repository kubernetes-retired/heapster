// Copyright 2016 Wavefront Inc. All Rights Reserved.
//
...
// Usage: ./heapster --source=kubernetes:http://192.168.64.2:8080?inClusterConfig=false --sink=wavefront:wavefront-proxy:2878?clusterName=k8s-cluster2\&prefix=heapster2.\&includeLabels=false\&includeContainers=false
package wavefront
