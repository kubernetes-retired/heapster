...
func TestStoreMultipleDataInput(t *testing.T) {
	...
	var expectMsgTemplate = [6]string{
		`{"GeneralMetricsTimestamp":%s,"MetricsTags":{"namespace_id":"","pod_id":"aaaa-bbbb-cccc-dddd"},"MetricsName":"test/metric/1","Cluster":"","MetricsValue":{"value":123456}}`,
		`{"GeneralMetricsTimestamp":%s,"MetricsTags":{"namespace_id":"123","pod_id":"aaaa-bbbb-cccc-dddd"},"MetricsName":"removeme","Cluster":"","MetricsValue":{"value":123456}}`,
		`{"GeneralMetricsTimestamp":%s,"MetricsTags":{"container_name":"/system.slice/-.mount","namespace_id":"123","pod_id":"aaaa-bbbb-cccc-dddd"},"MetricsName":"/system.slice/-.mount//cpu/limit","Cluster":"","MetricsValue":{"value":123456}}`,
		`{"GeneralMetricsTimestamp":%s,"MetricsTags":{"container_name":"/system.slice/dbus.service","namespace_id":"123","pod_id":"aaaa-bbbb-cccc-dddd"},"MetricsName":"/system.slice/dbus.service//cpu/usage","Cluster":"","MetricsValue":{"value":123456}}`,
		`{"GeneralMetricsTimestamp":%s,"MetricsTags":{"namespace_id":"123","pod_id":"aaaa-bbbb-cccc-dddd"},"MetricsName":"test/metric/1","Cluster":"","MetricsValue":{"value":123456}}`,
		`{"Cluster":"","CpuMetricsTimestamp":%s,"Metrics":{"cpu/limit":{"value":223456},"cpu/usage":{"value":123456}},"MetricsTags":{"container_name":"/system.slice/-.mount","namespace_id":"123","pod_id":"aaaa-bbbb-cccc-dddd"}}`,
	}
