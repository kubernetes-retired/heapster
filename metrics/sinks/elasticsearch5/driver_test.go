	...
	return fakeESSink{
		&elasticSearchSink{
			...
			esSvc: es5Common.ElasticSearchService{
				...
				ClusterName: es5Common.ESClusterName,
			},
		},
		savedData,
	}
...
func TestStoreMultipleDataInput(t *testing.T) {
	...
	var expectMsgTemplate = [6]string{
		`{"MetricsTimestamp":%s,"MetricsTags":{"cluster_name":"default","namespace_id":"","pod_id":"aaaa-bbbb-cccc-dddd"},"MetricsName":"test/metric/1","MetricsValue":{"value":123456}}`,
		`{"MetricsTimestamp":%s,"MetricsTags":{"cluster_name":"default","namespace_id":"123","pod_id":"aaaa-bbbb-cccc-dddd"},"MetricsName":"removeme","MetricsValue":{"value":123456}}`,
