...
func getPodLister(kubeClient *kube_client.Clientset) (*cache.StoreToPodLister, error) {
...
func getNodeLister(kubeClient *kube_client.Clientset) (*cache.StoreToNodeLister, error) {
