...
var (
	...
	heapsterControllerFile        = flag.String("heapster_controller", "../deploy/kube-config/influxdb/v1beta3/heapster-controller.yaml", "Path to heapster replication controller file.")
	influxdbGrafanaControllerFile = flag.String("influxdb_grafana_controller", "../deploy/kube-config/influxdb/v1beta3/influxdb-grafana-controller.yaml", "Path to Influxdb-Grafana replication controller file.")
	influxdbServiceFile           = flag.String("influxdb_service", "../deploy/kube-config/influxdb/v1beta3/influxdb-service.yaml", "Path to Inlufxdb service file.")
