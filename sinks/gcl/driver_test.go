...
func TestStoreEventsSingleEventInput(t *testing.T) {
	...
	assert.Equal(t, "/v1beta3/projects/fakeProjectId/logs/KubernetesEventsLog/entries:write" /* expected */, fakeSink.fakeHttpClient.capturedSendRequests[0].URL.Path /* actual */)
