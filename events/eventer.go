...
func validateFlags() error {
	...
	if *argFrequency < minFrequency {
		return fmt.Errorf("frequency needs to be greater than or equal to %s, supplied %s", minFrequency,
			*argFrequency)
	}

	if *argFrequency > api.MaxEventsScrapeDelay {
		return fmt.Errorf("frequency needs to be smaller than or equal to %s, supplied %s",
